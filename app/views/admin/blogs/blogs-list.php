                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <a href="javascript:void(0);" data-href="<?= SITE_ADMIN_URL . 'blogs/delete/' . encryptData($blo_data['blo_id']) ?>" class="btn btn-sm btn-danger" onclick="deleteData(this)"> Delete</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php } ?>
