...
class SettingsController
{
    ...
    public function index()
    {
        if (isset($_POST['save_setting'])) {
            ...
            $sql = "UPDATE " . WEBSITE_SETTINGS . " SET wes_name = :name, wes_mailer = :mailer, wes_mailer_host = :mail_host,
            wes_mailer_port = :mail_port, wes_mailer_encryption = :mail_enc, wes_mailer_uname = :mail_u_name, wes_mailer_upass = :mail_u_pass,
            wes_mailer_from_address = :mail_from_address, wes_mailer_from_name = :mail_from_name, wes_maintenance_mode = :mode, wes_maintenance_start_time = :s_date,
